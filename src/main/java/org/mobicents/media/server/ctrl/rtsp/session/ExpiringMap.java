...
/**
 * A map with expiration. This class contains a worker thread that will periodically check this
 * class in order to determine if any objects should be removed based on the provided time-to-live
 * value.
 */
public class ExpiringMap<K, V> implements Map<K, V> {
  ...
  /**
   * Creates a new instance of ExpiringMap using the default values DEFAULT_TIME_TO_LIVE and
  ...
  /**
   * Creates a new instance of ExpiringMap using the supplied time-to-live value and the default
   * value for DEFAULT_EXPIRATION_INTERVAL
   * 
  ...
  /**
   * Creates a new instance of ExpiringMap using the supplied values and a {@link ConcurrentHashMap}
  ...
  public ExpiringMap(int timeToLive, int expirationInterval) {
    this(new ConcurrentHashMap<K, ExpiringObject>(),
        new CopyOnWriteArrayList<ExpirationListener<V>>(), timeToLive, expirationInterval);
  }
